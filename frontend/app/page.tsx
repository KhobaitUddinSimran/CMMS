        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <h1 className="text-3xl font-black text-[#C90031] tracking-tight">CMMS</h1>
              <p className="text-xs font-semibold text-[#C90031]">Universiti Teknologi Malaysia</p>
            </div>
          </div>
          <nav className="hidden md:flex items-center gap-8">
            ...
            <button 
              ...
              className="px-6 py-2 bg-[#C90031] text-white rounded-lg text-sm font-medium hover:bg-[#A8002A] transition-colors"
            >
              Get Started
            </button>
          </nav>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                onClick={() => router.push('/auth/login')}
                className="px-8 py-3 bg-[#C90031] text-white rounded-lg font-semibold hover:bg-[#A8002A] transition-colors flex items-center justify-center gap-2"
              >
                Get Started
                <ArrowRight size={20} />
              </button>
              <a href="#features" className="px-8 py-3 border-2 border-white/40 text-white rounded-lg font-semibold hover:bg-white/10 transition-colors text-center">
                Learn More
              </a>
            </div>
          </div>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <p className="text-[#C90031] font-semibold text-sm uppercase tracking-wider">Trusted by UTM</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={idx} className="text-center">
                <p className="text-4xl font-bold text-[#C90031] mb-2">{stat.number}</p>
      ...
      <section id="features" className="py-24 bg-white scroll-mt-20">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            <p className="text-[#C90031] font-semibold text-sm uppercase tracking-wider">Why CMMS</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {FEATURES.map((feature, idx) => (
              <div key={idx} className="p-6 bg-gray-50 rounded-lg border border-gray-200 hover:border-[#C90031]/30 hover:shadow-lg transition-all">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-[#C90031] rounded-full"></div>
                  <div>
            ...
            <div>
              ...
              <button className="text-[#C90031] font-medium hover:text-[#A8002A]">
                Contact Support →
              </button>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-gray-300 py-12 border-t border-gray-800">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
            <p>&copy; 2026 Universiti Teknologi Malaysia. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
