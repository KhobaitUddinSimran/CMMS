        ...
        <Card>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-[12px] text-[#9CA3AF] mt-0.5">Sign out of your MarksDesk account</p>
            </div>
          </button>
        </Card>

        <p className="text-center text-[11px] text-[#D1D5DB]">MarksDesk v5.0 · Universiti Teknologi Malaysia</p>
      </div>
    </MainLayout>
  )
}
